...
var index = require('./index-1b221f99.js');
...
var parseIcons = function parseIcons(iconSet) {
  ...
  var parseIcon = function parseIcon(iconObject) {
    var obj;
    var icon = iconObject.icon; // Is library icon
    ...
    if (icon) {
      ...
      var path = icon[4];
      var attrs = icon[6];
      return obj = {}, obj["" + iconObject.iconName] = {
...
var parsePackIcons = function parsePackIcons(iconSet) {
  ...
  var packIcons = parseIcons(iconSet);
  return packIcons;
};
  ...
  return {
    ...
    computed: {
      ...
      baseStyle: function baseStyle() {
        ...
        return componentBaseStyleObjectOrFunction ? index.runIfFn(componentBaseStyleObjectOrFunction, Object.assign({}, this.splitProps.styleAttrs, this.splitProps.nativeAttrs, {
          theme: this.theme,
      ...
      className: function className() {
        ...
        var boxStylesObject = index.css(merged)(this.theme);
